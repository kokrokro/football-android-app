...
public class RVTournamentCommandCardAdapter extends RecyclerView.Adapter<RVTournamentCommandCardAdapter.ViewHolder> {
    ...
    RVTournamentCommandCardAdapter(Activity activity, TournamentCommandFragment context, List<Team> teams, String group,
                                   League leagueInfo) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.btnTitle.setOnClickListener(v -> {
            ...
            bundle.putString("LEAGUE_ID", leagueInfo.getId());
